...
import manageds.util.PaginationHelper;
import sessions.AirlinesFacade;
...
@SessionScoped
public class AirlinesController implements Serializable {

    private Airlines current;
    private DataModel items = null;
    @EJB
    private sessions.AirlinesFacade ejbFacade;
    ...
    private AirlinesFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("AirlinesCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("AirlinesUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("AirlinesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class AirlinesControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            AirlinesController controller = (AirlinesController) facesContext.getApplication().getELResolver().
